  ...
  return (
    <div className="bg-bg-card border border-border rounded-xl p-6">
      <div className="flex items-center justify-between mb-6">
        <h2 className="text-lg font-semibold text-text-primary">Insights & Alerts</h2>
      ...
      {loading ? (
        <div className="space-y-3">
          {[1, 2, 3].map((i) => (
            <div key={i} className="h-20 bg-bg-hover rounded-lg animate-pulse" />
          ))}
        </div>
      ) : error ? (
        ...
        <div className="text-center py-8">
          ...
          <div className="text-text-muted text-sm">All clear. No alerts or recommendations at this time.</div>
        </div>
      ) : (
        <div className="space-y-3">
            ...
            return (
              ...
              >
                <div className="flex items-start gap-3">
                  <div className={`w-6 h-6 rounded-full flex items-center justify-center text-xs font-bold flex-shrink-0 mt-0.5 ${styles.badge}`}>
                    {styles.icon}
                  </div>
