          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-border">
                ...
                <th className="text-right py-3 px-2 text-text-muted font-medium text-xs uppercase tracking-wider">
                  Tokens
                </th>
                <th className="text-right py-3 px-2 text-text-muted font-medium text-xs uppercase tracking-wider">
                  Cost
                ...
                <th className="text-center py-3 px-2 text-text-muted font-medium text-xs uppercase tracking-wider">
                  Status
                </th>
              </tr>
            </thead>
